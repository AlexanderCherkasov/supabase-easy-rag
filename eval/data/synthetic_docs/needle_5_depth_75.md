...
Evaluate validation loss every 100 steps. Apply early stopping if evaluation loss diverges from tra
...
ining loss for more than 3 consecutive evaluation cycles.
